...
<div class="container-fluid">
    ...
    <div class="col-sm-12">
      ...
      @endif
		...
		<div class="col-sm-12">
			<div class="row">
				<form method="post" action="{{url('adddesa')}}" enctype="multipart/form-data">
          {{ csrf_field() }}
					...
					<div class="col-sm-3">
						...
						<div class="content cat-content">
             			...
             			@foreach($categories as $cat)	
							<p><label for="{{$cat->cid}}"><input type="checkbox" name="category_id[]" value="{{$cat->cinid}}"> {{$cat->title}}</label></p>
              			@endforeach
						</div>
